...
> **Sinh viên thực hiện:** Bùi Thị Diễm My – MSSV 23638831
> **Repository:** `23638831_BuiThiDiemMy_cabsystem`

---

## Mục lục

1. [Các bên liên quan (Stakeholders)](#1-các-bên-liên-quan-stakeholders)
2. [Kỳ vọng của khách hàng và hệ thống](#2-kỳ-vọng-của-khách-hàng-và-hệ-thống)
3. [Mục đích nghiệp vụ](#3-mục-đích-nghiệp-vụ)
4. [Quy trình nghiệp vụ (Business Process)](#4-quy-trình-nghiệp-vụ-business-process)
5. [Phạm vi dự án trong 7 tuần](#5-phạm-vi-dự-án-trong-7-tuần)
6. [Business Requirements](#6-business-requirements)
7. [Functional Requirements](#7-functional-requirements)
8. [Use Case Diagram](#8-use-case-diagram)
9. [Đặc tả Use Case](#9-đặc-tả-use-case)
10. [Phân tích quy trình nghiệp vụ (AS-IS / TO-BE)](#10-phân-tích-quy-trình-nghiệp-vụ)
...
### 1.1. Danh sách các bên liên quan
...
---
### 1.3. Stakeholder quan trọng nhất
...
## 2. Kỳ vọng của khách hàng và hệ thống
...
### 3.2. Nghiệp vụ cần làm những gì?
...
### 4.2. Quy trình tìm và phân công tài xế
...
### 4.3. Quy trình thực hiện chuyến đi
...
### 4.4. Các nhóm chức năng hệ thống
...
### 4.6. Mối quan hệ giữa nghiệp vụ và hệ thống
...
---
### 5.3. Phân chia các Module theo 7 tuần
...
### 6.2. Danh sách Business Requirements
...
### 6.4. Phân nhóm Business Requirements
...
### 6.5. Bảng Business Requirements tổng hợp
...
### 7.6. FR05 – Tìm và phân công tài xế
...
### 7.8. FR07 – Tính cước và thanh toán
...
### 7.13. FR12 – Phân quyền và bảo mật
...
### 7.15. Functional Requirement Tree
...
### 7.16. Các chức năng ưu tiên cho MVP 7 tuần
...
### 7.17. Mối quan hệ Business Requirement → Functional Requirement
...
### 8.2. Use Case Diagram – Tổng quan
...
### 8.4. Use Case – Tìm và phân công tài xế
...
### 8.5. Use Case – Thực hiện chuyến đi
...
### 8.8. Use Case – Quản trị hệ thống
...
### 8.9. Các quan hệ Use Case quan trọng
...
### 8.10. Use Case Diagram MVP – 7 tuần
...
### 8.11. Các Use Case nên ưu tiên trong MVP
...
### 9.4. UC04 – Tìm và phân công tài xế
...
### 10.1. Quy trình nghiệp vụ hiện tại – AS-IS
...
### 10.2. Quy trình nghiệp vụ đề xuất – TO-BE
...
### 10.4. Các điểm quyết định quan trọng trong quy trình
...
### 11.3. Business Rules chưa được xác định
...
### 11.4. Business Rule – Quy trình tìm tài xế
...
### 11.5. Business Rule – Trạng thái chuyến
...
flowchart LR
    ...
    B --> C[Use Case Diagram]
    C --> D[Use Case Specification]
    D --> E[Business Process]
    E --> F[Business Rules]
    F --> G[Open Issues]
    G --> H[MVP Scope]
```
